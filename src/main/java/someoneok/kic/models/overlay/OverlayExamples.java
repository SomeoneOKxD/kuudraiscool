...
public class OverlayExamples {
    ...
    public static final String KUUDRA_SUPPLY_TIMES = "§b§lSupply Times [§a6§8/§a6§b§l]\n" +
            "§bAnt §r§8(1/6) §r§f§l16.87s\n" +
            "§6Rain §r§8(2/6) §r§f§l16.89s\n" +
            "§aWelly §r§8(3/6) §r§f§l17.37s\n" +
            "§6Soph §r§8(4/6) §r§f§l17.87s\n" +
            "§6Rain §r§8(5/6) §r§9§l25.94s\n" +
            "§6Soph §r§8(6/6) §r§9§l25.94s";

    public static final String KUUDRA_FRESH_TIMES = "§b§lFresh Times [§2§l3§b§l]\n" +
            "§bAnt §9§l4.16s\n" +
            "§6Rain §a§l6.84s\n" +
            "§6Soph §6§l7.20s";
